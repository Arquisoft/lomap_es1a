...
The deployment url is: [https://arquisoft.github.io/lomap_es1a/](https://arquisoft.github.io/lomap_es1a/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_es1a/](https://arquisoft.github.io/lomap_0/) we need to execute `npm run deploy`.
